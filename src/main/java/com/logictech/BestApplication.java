...
public class BestApplication {
    ...
    public static final Logger logger = LoggerFactory.getLogger(BestApplication.class);
    public static void main(String[] args) {
        ConfigurableApplicationContext context = SpringApplication.run(BestApplication.class, args);
